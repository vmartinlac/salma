...
void KFDFilter::filter( double timestamp, const std::vector<cv::Point2f>& projections, const std::vector<cv::Point3f>& landmarks )
{
}

void KFDFilter::getPose(Sophus::SE3d& pose)
{
}

void KFDFilter::getPoseCovariance(Eigen::Matrix<double, 7, 7>& sigma)
{
}
