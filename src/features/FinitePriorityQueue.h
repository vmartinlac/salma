...
template<typename item_type, typename priority_type, size_t D>
class FinitePriorityQueueF
{
public:

    FinitePriorityQueueF()
    {
        clear();
    }
...
protected:
    ...
    std::array<item_type,D> _items;
    std::array<priority_type,D> _priorities;
    size_t _size;
    size_t _weaker;
    size_t _stronger;
};
